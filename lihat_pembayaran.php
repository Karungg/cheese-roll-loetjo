...
if ($_SESSION['pelanggan']['id_pelanggan'] !== $detpemb->id_pelanggan) {
	echo "<script>
    window.location.href = 'riwayat.php';
    </script>";	
	exit();
...
<html lang="en">
  ...
  <main>
    <div class="py-5 text-center">
      <h2 class="text-primary">Lihat Pembayaran</h2>
    </div>
    <div class="row g-5 justify-content-center bg-secondary p-5">
      
      <div class="col-md-10 col-lg-10">
      <div class="row mb-4">
    <div class="col-sm-6">
    <div>
    <strong>Tanggal : <?= $detpemb->tanggal_pembelian; ?></strong>
    </div>
    <div>Total : Rp. <?= number_format($detpemb->total_pembelian); ?></div>
    </div>
        <div class="col-sm-6">
        <h6 class="mb-3">Pelanggan :</h6>
        <div>
        <strong><?= $detpemb->nama; ?></strong>
        </div>
        <div>Bank : <?= $detpemb->bank; ?></div>
        <div>Jumlah : Rp.<?= number_format($detpemb->jumlah); ?></div>
        </div>
        </div>
          <div class="row g-3">
            <div class="col-12">
              <label for="bukti" class="form-label">Bukti Pembayaran</label>
              <img class="img-fluid" src="assets/img/bukti/<?= $detpemb->bukti; ?>" alt="">
            </div>
          </div>
      </div>
    </div>
