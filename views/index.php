    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-dark sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="?page=dashboard">
                ...
                <div class="sidebar-brand-text mx-3">Cheese Roll</div>
            </a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="?page=buyer">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                }elseif(@$_GET['page'] == 'detail-buyer'){
                    include 'buyer/detail.php';
                }elseif(@$_GET['page'] == 'pembayaran'){
                    include 'buyer/pembayaran.php';
                }
                ?>
                </div>
                <!-- /.container-fluid -->
